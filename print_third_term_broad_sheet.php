...
th{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;
width:100px;
height:60px;
}
tr{
...
echo "<center><h2>$class third Term Broad Sheet</h2></center>";
...
$perc=round($t,2)."%";
//echo $perc."<br>";
$query6="INSERT INTO ".str_replace(" ","_",$class)."_third_term_broad_sheet (student_id,name,$subjs first_term_score, second_term_score, third_term_score, total_average, percentage, position) VALUES ('$student_ids[$i]','$names[$i]',$values'$ftotal','$stotal','$total','$avr','$perc','".SESSION."')";
...
echo "</table>";
echo'<a href="thirdterm_broad_sheet.php?C='.$_GET['C'].'&id='.$_GET['id'].'">Go Back</a>';
